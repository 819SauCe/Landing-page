...
let projects = [
    { img: noPicture, nome: "Projeto 1", descricao: "teste", link: "url" },
    { img: noPicture, nome: "Projeto 2", descricao: "teste", link: "url" },
    { img: noPicture, nome: "Projeto 3", descricao: "teste", link: "url" },
    { img: noPicture, nome: "Projeto 4", descricao: "teste", link: "url" },
    { img: noPicture, nome: "Projeto 5", descricao: "teste", link: "url" }
  ];
